...
const Navbar = () => {
  const { user, isAuthenticated,isVisibleForm,setIsVisibleForm } = useGlobalContext();
        ...
        <div className="flex items-center justify-between relative">
          ...
          <div className="p-6 justify-end hidden md:flex">
            {isAuthenticated ? (
              ...
              <div>
                <button className="bg-primary text-white px-4 py-2 rounded-full" onClick={()=>setIsVisibleForm(true)}>
                  Log In/ Sign Up
                </button>
              </div>
            )}
          ...
          {/* Mobile Menu Buttossn - Right aligned */}
              ...
              >
                ...
                <div className="mt-4">
                  {isAuthenticated ? (
                    ...
                    // <NavLink to="/login">
                      <button className="bg-primary text-white px-4 py-2 rounded-full w-full" onClick={()=>setIsVisibleForm(true)}>
                        Log In
                      </button>
                    // </NavLink>
                  )}
