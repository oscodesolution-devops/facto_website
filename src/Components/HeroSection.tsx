            ...
            : // Show actual sub-services when data is loaded
              filteredSubServices.map((subService) => (
                <PricingCard
                  ...
                  pricingStructure={subService.pricingStructure}
                />
              ))
      ...
      <div className="mt-16 px-4 sm:px-6 md:px-10 lg:px-28 xl:px-36">
        ...
        >
          <p>
            ...
            details, investment information, and proof of additional income such
            as from property or capital gains.
          </p>
          <p>
        ...
        <div data-aos="fade-up" className="mt-5">
          <button
            ...
            className="bg-[#3AB54A] border border-[#00750F] text-white rounded-md px-8 py-2 text-sm font-semibold font-[inter] tracking-wider"
          >
            Contact Us
          </button>
        </div>
