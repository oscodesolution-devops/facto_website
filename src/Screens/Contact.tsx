  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="pt-[60px]">
        <div
          data-aos="fade-up"
          className="flex justify-center font-[poppins] font-[300] text-[16px]"
        >
          OUR TEAM
        </div>
        <div
          data-aos="fade-up"
          className="flex justify-center font-[poppins] font-[500] text-[35px]"
        >
          Meet Our Facto Team
        </div>
      </div>
      ...
      <div
        data-aos="fade-up"
        className="font-[poppins] font-[500] flex pt-[40px] pb-[88px] gap-8 flex-wrap justify-center sm:gap-4 overflow-hidden"
      >
        <ComponentCard
      ...
      <div className="px-4 sm:px-8 md:px-16 lg:pl-[63px] overflow-hidden">
        ...
        >
          FACTO - WE ARE HERE TO ASSIST IN ALL TAX FILING, REGISTRATION AND
          UPDATES Your trusted partner for all things like GST and tax filing.
          We simplify the complex world of taxation by offering user-friendly
          tools and expert support to ensure accurate and timely filing. Whether
          you are an individual, small business, or enterprise, we help you
          navigate GST compliance, income tax returns, and other tax-related
          services with ease. Our mission is to make tax filing hassle-free,
          transparent, and efficient, so you can focus on what matters
          most—growing your business. Join thousands of satisfied users and
          experience seamless, reliable tax solutions today! We also provide
          regular updates on tax, finance, and related topics to keep you
          informed and ahead of the curve. Our expert team ensures you receive
          timely, accurate information on changes in tax laws, regulations, and
          financial trends, helping you make well-informed decisions
        </div>
        <div className="font-[poppins] font-[300] pt-[30px] pb-[100px] text-center sm:text-left">
          <span data-aos="fade-up" className="font-[500]">
            Address:
          </span>{" "}
          G-105 second floor, Arya samaj road, Uttam nagar, New Delhi, 110059
        </div>
      </div>

      {/* Contact Info Section - Unchanged */}
      <div className="bg-[#E9FFE9] px-4 sm:px-8 md:px-16 lg:px-[64px] w-full sm:w-full md:w-[90%] lg:w-[80%] ml-0 sm:ml-[20px] md:ml-[60px] lg:ml-[80px] pt-[30px] pb-[30px] flex flex-col lg:flex-row items-center lg:items-start overflow-hidden">
        <img
