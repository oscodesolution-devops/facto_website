  ...
  return (
    <div>
      ...
      <div className="bg-[#DDE2FF]">
        ...
        <div className="px-[130px] py-[60px]">
          <div className="bg-[white] w-[371px] h-[50px] font-[poppins] font-[500] text-[#3AB54A] pt-[13px] px-[10px]">
            Active Services
          </div>
          <div className="w-[1000px] pt-[20px] flex flex-col gap-[15px]">
